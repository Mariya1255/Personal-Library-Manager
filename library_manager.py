...
lottie_book = load_lottieurl("https://assest9.lottieflies.com/temp/if20 aKAfIn.json") 
if lottie_book:
    with st.sidebar:
...
""", unsafe_allow_html=True) 
            ...
            st.markdown("<div class= 'warning-message'> No booksfound matching your search.</div>", unsafe_allow_html=True)

elif st.session_state.current_view =="stats":
    st.markdown("<h2 class='sub-header'> Library statistics</h2>", unsafe_allow_html=True)

    if not st.session_state.library:
        st.markdown("<div class='waring-message'> Your library is epty. Add some books to see stats!</div>", unsafe_allow_html=True)
    else:
...
st.markdown("---") 
st.markdown("Copyright @ 2025 Mariya Khan Personal Library Manager", unsafe_allow_html=True)               
